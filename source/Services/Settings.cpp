...
std::string Settings::GetFirmwareVersion() {
    ...
    #else
    std::string str = std::string("Unknown FW Version");
    #endif
...
std::string Settings::GetSerialNumber() {
    ...
    #else
    std::string str = std::string("Unknown Serial Number");
    #endif
	return str;
}
...
std::string Settings::GetDeviceNickname() {
    #ifdef __SWITCH__
    std::__cxx11::string nick = "None";
    nick = GetDeviceNickname();
